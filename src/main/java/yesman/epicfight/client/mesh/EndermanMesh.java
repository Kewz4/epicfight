...
public class EndermanMesh extends SkinnedMesh implements MeshProvider<EndermanMesh> {
	...
	public EndermanMesh(Map<String, Number[]> arrayMap, Map<MeshPartDefinition, List<SkinnedMeshVertexBuilder>> parts, SkinnedMesh parent, RenderProperties properties) {

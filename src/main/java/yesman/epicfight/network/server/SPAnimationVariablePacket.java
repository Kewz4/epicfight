...
public class SPAnimationVariablePacket<T> extends AnimationVariablePacket<T> {
	...
	public SPAnimationVariablePacket(LivingEntityPatch<?> entitypatch, SynchedAnimationVariableKey<T> animationVariableKey, @Nullable AnimationAccessor<? extends StaticAnimation> animation, T value, Action action) {
		super(animationVariableKey, animation, value, action);
		this.entityId = entitypatch.getOriginal().getId();
	}
	
	public SPAnimationVariablePacket(int entityId, SynchedAnimationVariableKey<T> animationVariableKey, @Nullable AnimationAccessor<? extends StaticAnimation> animation, T value, Action action) {
		super(animationVariableKey, animation, value, action);

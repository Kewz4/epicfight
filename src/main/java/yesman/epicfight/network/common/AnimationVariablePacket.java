...
public abstract class AnimationVariablePacket<T> {
	protected AnimationAccessor<? extends StaticAnimation> animation;
	protected SynchedAnimationVariableKey<T> animationVariableKey;
	protected T value;
	protected Action action;
	
	public AnimationVariablePacket(SynchedAnimationVariableKey<T> animationVariableKey, @Nullable AnimationAccessor<? extends StaticAnimation> animation, T value, Action action) {

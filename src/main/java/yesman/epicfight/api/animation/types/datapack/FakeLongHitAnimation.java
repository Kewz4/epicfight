...
@OnlyIn(Dist.CLIENT)
public class FakeLongHitAnimation extends LongHitAnimation implements ClipHoldingAnimation {
	protected AnimationClip clip;
	protected FakeAnimation fakeAnimation;
	
	public FakeLongHitAnimation(float convertTime, String path, Armature armature) {
	...
	public FakeAnimation buildAnimation(JsonArray rawAnimationJson) {
		...
		fakeAnimation.setAnimationClass(FakeAnimation.AnimationType.LONG_HIT);
